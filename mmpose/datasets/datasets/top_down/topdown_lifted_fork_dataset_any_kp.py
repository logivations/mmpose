...
class LiftedForkDatasetAnyKP(TopDownBaseDataset):
    ...
    def __init__(self,
        ...
        keypoints = [
            cat['keypoints'] for cat in self.coco.loadCats(self.coco.getCatIds())
        ]
    ...
    def _load_coco_keypoint_annotation_kernel(self, img_id):
        ...
        for obj in objs:
            ...
            self.ann_info['flip_pairs'] = create_flip_pairs(keypoints.shape[0])
            keypoints = np.vstack((keypoints, np.zeros((num_joints - keypoints.shape[0], keypoints.shape[1]))))
